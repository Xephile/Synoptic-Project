...
const EditForm = (props: any) => {
    ...
    return (<form className="bg-light p-3" onSubmit={submitFormHandler}>
        <div className="w-75 d-flex mb-2">
            ...
            <input type="text" id="tags" ref={tagsInputRef} className="me-2 w-50 form-control" placeholder={props.tags} />
        </div>
        <div className="w-75 d-flex">
            ...
            <input type="text" id="time" ref={timeInputRef} className="me-2 w-25 form-control" placeholder={props.time} />

            <label htmlFor="type" className="my-auto pe-2">Type:</label>
            <input type="text" id="type" ref={typeInputRef} className="me-2 w-25 form-control" placeholder={props.type} />
